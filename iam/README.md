...
|------|-------------|------|---------|:--------:|
| <a name="input_create_account"></a> [create\_account](#input\_create\_account) | n/a | `map(string)` | n/a | yes |
| <a name="input_get_sa"></a> [get\_sa](#input\_get\_sa) | n/a | `map(string)` | n/a | yes |
